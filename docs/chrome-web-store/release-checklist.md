# PromptLens v0.3.0 Release Checklist
...
- [ ] Confirm `dist/promptlens-v0.3.0.zip` exists.
- [ ] Run `unzip -Z1 dist/promptlens-v0.3.0.zip | sort`.
...
- [ ] Confirm `v0.3.0` tag does not already exist locally or remotely before creating it.
- [ ] Create annotated tag `v0.3.0`.
- [ ] Create GitHub Release `v0.3.0`.
- [ ] Upload `dist/promptlens-v0.3.0.zip` as the Release artifact.
- [ ] Confirm the Release page shows the uploaded zip.

## Website

- [ ] Confirm `site/index.html` download links point to `https://github.com/wildbyteai/promptlens/releases/tag/v0.3.0`.
- [ ] Confirm `site/privacy/index.html` download links point to `https://github.com/wildbyteai/promptlens/releases/tag/v0.3.0`.
- [ ] Confirm `site/support/index.html` download links point to `https://github.com/wildbyteai/promptlens/releases/tag/v0.3.0`.
