...
- [ ] Confirm `dist/promptlens-v0.5.1.zip` exists.
- [ ] Run `unzip -Z1 dist/promptlens-v0.5.1.zip | sort`.
...
- [ ] Confirm `v0.5.1` tag does not already exist locally or remotely before creating it.
- [ ] Create annotated tag `v0.5.1`.
- [ ] Create GitHub Release `v0.5.1`.
- [ ] Upload `dist/promptlens-v0.5.1.zip` as the Release artifact.
