...
| 分析結果 | ChatGPT Plus 輔助 |
| --- | --- |
| <img src="./docs/assets/promptlens-result.png" alt="PromptLens 分析結果頁" /> | <img src="./docs/assets/promptlens-chatgpt-assist.jpg" alt="PromptLens ChatGPT Plus 輔助交接" /> |
